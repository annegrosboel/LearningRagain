...
Hvis man laver en gruppe der til at starte med, så skal man ungroupe det. 
...
Tallet er hvor mange decimaler man gerne vil have. 
```{r}
tidied_post_meal_data |>
  group_by(Group) |>
  summarise(
...
As seen in @tbl-mean-age-bmi yes yes
